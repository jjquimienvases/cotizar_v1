...
$src = "https://cotizar.jjquimienvases.com/items/imagenes/".$nombreImg;
           ...
           $sql_ = "INSERT INTO producto_av (id,contratipo,stock,genero,precio,gramo,id_categoria,peso,ubicacion,unidad,minimo,maximo,imagen,name_prov,visibilidad,price_orden) VALUES ($item_code,'$item_name',$stock,'$genero',0, $costo,$categoria,$peso,'$ubicacion','$unidad_empaque', $stock_minimo,$stock_maximo,'$src','$nombre_proveedor',1,$costo)";
