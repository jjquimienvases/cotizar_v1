...
$sql_get_costo = $conexion->query("SELECT * FROM producto_av WHERE id =$skus");

foreach($sql_get_costo as $data):
    $costo = $data['gramo'];
...
if ($id_categoria == 4) {
    ...
    $centena = $costo;
    $millar = $costo;
} else if ($id_categoria == 72) {
    $millar = ($con_iva * 0.15) + $con_iva;
} else if ($id_categoria == 71) {
    $millar = ($con_iva * 0.20) + $con_iva;
} else if ($id_categoria == 40) {
    $unitario = 13000;
    $docena = 35000;
    $centena = 70000;
    $millar = "Costo Kilo";
    ...
    $centena = ($con_iva * 0.20) + $con_iva;
    $millar = ($con_iva * 0.20) + $con_iva;
} else if ($id_categoria == 25) {
    $unitario = 5000;
    $docena = 19000;
    $centena = 35000;
    $millar = 35000;
} else if ($id_categoria == 46) {
    $unitario = 1050;
    $docena = 1050;
    $centena = 1050;
    $millar = 1050;
