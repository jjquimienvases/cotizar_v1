<div class="container mt-5 mb-2">
    ...
    <div class="row">
        ...
        <div class="col-4">
            ...
            <input type="text" class="form-control rounded-pill border-success" name="price" id="price">
        </div>
    </div>
    <hr>
    ...
    <hr>
    <button type="button" id="send_create_item" class="uk-button uk-button-default text-right mb-3 border-success">CARGAR NUEVO PRODUCTO</button>
