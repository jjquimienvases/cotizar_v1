...
class cotizacionModelo extends main
{
    ...
    public static function agregar_Cotizacion_modelo_call($datos)
    {
        $pendiente = "pendiente";
        $pdo = main::conectar();
        ...
        $stmt->bindParam(':ESTADO', $pendiente);
    ...
    {
        $stmt = main::conectar()->prepare("UPDATE producto set stock=:STOCK where id=ID;");
