...
if($_SESSION['id_rol'] == 4){
    ...
    header("Location:create_invoice_ibague.php");
}else if($_SESSION['id_rol'] == 2){
    header("Location:create_invoice2.php");
}else if($_SESSION['id_rol'] == 3){
     header("Location:create_invoice_d1.php");
}
...
<script src="js/invoice_call.js"></script>
...
<?php include('containermostrador.php');?>
...
<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
    <h2 class="title">Cotizaciones call center</h2>
 ...
 <button id="myBtnes">Editar Cliente</button>
			...
			<div style="text-align: center;">
							<select id="buscarcliente" style="width: 100%">
								...
								<?php
								$query = $mysqli -> query ("SELECT * FROM clientes ORDER BY nombres ASC");
...
<td><input class="itemsmercado" type="checkbox" id="mercado" name="mercado"></td>    </div>
<div class="form-group">
...
<select name="metodopago" class="pagoselection">
 ...
 <option value="mostradorjj">mostrador JJ</option>
...
$(document).ready(function () {
  mostrar_fila();
        ...
        alertify.alert("BIENVENIDO "+usuario+" Recuerda completar todos los campos para guardar tu cotizacion correctamente");
    });
		...
		$('#guardando').click(function(){
			...
			$.ajax({
					...
					if(r!=0 && !isNaN(r)){//SI ES DISTINTO A 0 Y ES UN NUMERO
						...
						if (respuesta == true){
							windowObjectReference = window.open(
						  	"print_invoice.php?invoice_id="+r,
             ...
             window.location="search/index.php";
						...
						alert("Completar todos los campos,en caso tal de no funcionar contactar con el desarrollador");
					}
				}
			});
			return false;
