...
class cotizacionControlador_prueba extends cotizacionModelo
{
    public function agregar_Cotizacion_controlador()
    {
        ...
        if ($cliente == "" || $cedula == "") {
            ...
            echo json_encode($alerta);
            exit();
        } else if ($resultado == "" || $subtotal == "" || $subtotal == "0" || $subtotal == "NaN" || $totalAft == "") {
            $alerta = [
                "Alerta" => "simple",
                "Titulo" => "Ocurrio un error",
        ...
        //                                 echo "<pre>";
        //      print_r("ESTES ES EL ID DEL CLIENTE: ".$idcliente);
        //       print_r("ESTOS SON LOS PUNTOS: ". $puntos_especiales[$i]);
        // echo "</pre>";  
                   // }//fin del if de la capacida
                }
            }
