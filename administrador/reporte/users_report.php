...
<html lang="en" dir="ltr">
  ...
  <body>
      ...
      <br>
     <center><h1>Reporte de ventas por empleados</h1></center> 
     <form action="" method="post"  enctype="multipart/form-data">
      ...
      <table class="table table-bordered table-hover">
           <center>
               <tr colspan="2">
               <th bgcolor="#F4960E"><center>Tamara Franca</center></th>
               <th bgcolor="#F4960E"><center>Promedio</center></th>
               </tr>
               <tr>
                 ...
                 <tr colspan="2">
                          <th bgcolor="#F4500E"><center>Nidia Cantillo</center></th>
                          <th bgcolor="#F4500E"><center>Promedio</center></th>
                 </tr>
            <tr>
            ...
            <tr colspan="2">
             <th bgcolor="#FD2507"><center>Sergio Martinez</center></th>
             <th bgcolor="#FD2507"><center>Promedio</center></th>
            </tr>
               <tr>
                 <td> <?php echo "Monto Efectivo: ".formatear($monto_sergio) ?>  
                 <br>
                 <?php echo "Cantidad Ventas: ".$count_sergio ?>  </td>
                ...
                <tr colspan="2">
                <th bgcolor="#00ABD1"> <center>Karen Rivera</center></th>
                <th bgcolor="#00ABD1"> <center>Promedio</center></th>

                </tr>
                <tr>
                 <td> <?php echo "Monto Efectivo: ".formatear($monto_karen) ?> 
                  <br>
                 <?php echo "Cantidad Ventas: ".$count_karen ?>  </td>
                 <td><?php $promedio_karen = $monto_karen/$count_karen ?> 
                       El promedio de venta por cliente fue de <?php echo formatear($promedio_karen); ?>
                  </td>
                </tr>
                <tr colspan="2">
               <th bgcolor="#5CCFE8"><center>Maria Omaña</center></th>
               <th bgcolor="#5CCFE8"><center>Promedio</center></th>
                    
                </tr>
                <tr>
                 <td> <?php echo "Monto Efectivo: ".formatear($monto_maria) ?>    
                 <br>
                <?php echo "Cantidad Ventas: ".$count_maria ?>  </td> 
                ...
                <!-- Segunda parte -->
               <tr colspan="2">
               <th bgcolor="#00D1FF"><center>Leidy Velasco</center></th>
               <th bgcolor="#00D1FF"><center>Promedio</center></th>
               </tr>
       
                <tr colspan="9">
                <td> <?php echo "Monto Efectivo: ".formatear($monto_leidy) ?>
                <br>
                <?php echo "Cantidad Ventas: ".$count_leidy ?>  </td>    
              ...
              <tr>
                 ...
                 <br>
                 <?php echo "Cantidad Ventas: ".$count_elizabeth ?>  </td>
              ...
              <tr>
                 ...
                 <br>
                 <?php echo "Cantidad Ventas: ".$count_diego ?>  </td>
              ...
              <tr>
                 ...
                 <br>
                 <?php echo "Cantidad Ventas: ".$count_michel ?>  </td>
              ...
              <tr>
                 ...
                 <br>
                 <?php echo "Cantidad Ventas: ".$count_linda ?>  </td>
             ...
             <th>Promedio</th>
              ...
              <tr>
                 ...
                 <br>
                 <?php echo "Cantidad Ventas: ".$count_leidyj ?>  </td>
              ...
              <tr>
                 ...
                 <br>
                 <?php echo "Cantidad Ventas: ".$count_angie ?>  </td>
