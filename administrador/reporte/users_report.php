...
$consulta_user = $cnx->query("SELECT * FROM factura_usuarios");
...
$_tamaria_2 = mysqli_real_escape_string($cnx, $tamarita);
...
$consulta_datos_tamara = $cnx->query("SELECT SUM(order_total_after_tax) as total_tamara FROM factura_orden WHERE order_date BETWEEN '$fecha_inicio' AND '$fecha_final' AND order_receiver_address LIKE '%$tamara_1%' AND metodopago ='$mostrador' AND estado LIKE '%$finalizado%'");
//  echo "<pre>";
...
$consulta_ventas_tamara = $cnx->query("SELECT count(user_id) as total_tamara_count FROM factura_orden WHERE order_date BETWEEN '$fecha_inicio' AND '$fecha_final' AND order_receiver_address LIKE '%$tamara_1%' AND metodopago ='$mostrador' AND estado LIKE '%$finalizado%'");
...
$consulta_datos_nidia = $cnx->query("SELECT SUM(order_total_after_tax) as total_nidia FROM factura_orden WHERE order_date BETWEEN '$fecha_inicio' AND '$fecha_final' AND order_receiver_address LIKE '%$nidia_1%' AND metodopago ='$mostrador' AND estado LIKE '%$finalizado%'");


$datos_ventas_nidia = mysqli_fetch_assoc($consulta_datos_nidia);
$monto_nidia = $datos_ventas_nidia['total_nidia'];

$consulta_ventas_nidia = $cnx->query("SELECT count(user_id) as total_nidia_count FROM factura_orden WHERE order_date BETWEEN '$fecha_inicio' AND '$fecha_final' AND order_receiver_address LIKE '%$nidia_1%' AND metodopago ='$mostrador' AND estado LIKE '%$finalizado%'");
...
$consulta_datos_sergio = $cnx->query("SELECT SUM(order_total_after_tax) as total_sergio FROM factura_orden WHERE order_date BETWEEN '$fecha_inicio' AND '$fecha_final' AND order_receiver_address LIKE '%$sergio_1%' AND metodopago ='$mostrador_d1' AND estado LIKE '%$finalizado%'");


$datos_ventas_sergio = mysqli_fetch_assoc($consulta_datos_sergio);
$monto_sergio = $datos_ventas_sergio['total_sergio'];

$consulta_ventas_sergio = $cnx->query("SELECT count(user_id) as total_sergio_count FROM factura_orden WHERE order_date BETWEEN '$fecha_inicio' AND '$fecha_final' AND order_receiver_address LIKE '%$sergio_1%' AND metodopago ='$mostrador_d1' AND estado LIKE '%$finalizado%'");
...
$consulta_datos_karen = $cnx->query("SELECT SUM(order_total_after_tax) as total_karen FROM factura_orden WHERE order_date BETWEEN '$fecha_inicio' AND '$fecha_final' AND order_receiver_address LIKE '%$karen_1%' AND metodopago ='$mostrador' AND estado LIKE '%$finalizado%'");


$datos_ventas_karen = mysqli_fetch_assoc($consulta_datos_karen);
$monto_karen = $datos_ventas_karen['total_karen'];

$consulta_ventas_karen = $cnx->query("SELECT count(user_id) as total_karen_count FROM factura_orden WHERE order_date BETWEEN '$fecha_inicio' AND '$fecha_final' AND order_receiver_address LIKE '%$karen_1%' AND metodopago ='$mostrador' AND estado LIKE '%$finalizado%'");
...
$consulta_datos_maria = $cnx->query("SELECT SUM(order_total_after_tax) as total_maria FROM factura_orden WHERE order_date BETWEEN '$fecha_inicio' AND '$fecha_final' AND order_receiver_address LIKE '%$maria_1%' AND metodopago ='$mostrador' AND estado LIKE '%$finalizado%'");


$datos_ventas_maria = mysqli_fetch_assoc($consulta_datos_maria);
$monto_maria = $datos_ventas_maria['total_maria'];

$consulta_ventas_maria = $cnx->query("SELECT count(user_id) as total_maria_count FROM factura_orden WHERE order_date BETWEEN '$fecha_inicio' AND '$fecha_final' AND order_receiver_address LIKE '%$maria_1%' AND metodopago ='$mostrador' AND estado LIKE '%$finalizado%'");
...
// $consulta_datos_leidy = $cnx ->query("SELECT SUM(total) as total_leidy FROM files INNER JOIN call_de_punto_venta ON files.order_id = call_punto_de_venta.order_id INNER JOIN factura_modificada ON files.order_id = factura_modificada.order_id WHERE order_date BETWEEN '$fecha_inicio' AND '$fecha_final'");
$consulta_datos_leidy = $cnx->query("SELECT SUM(total) as total_leidy FROM factura_modificada WHERE order_date BETWEEN '$fecha_inicio' AND '$fecha_final'");
...
$consulta_ventas_leidy = $cnx->query("SELECT count(order_id) as total_leidy_count FROM factura_modificada WHERE order_date BETWEEN '$fecha_inicio' AND '$fecha_final'");

$data_leidy = mysqli_fetch_assoc($consulta_ventas_leidy);
$count_leidy = $data_leidy['total_leidy_count'];

//informacion de leidy 
$consulta_datos_leidy_bc = $cnx->query("SELECT SUM(total) as total_leidy_bc FROM factura_modificada WHERE order_date BETWEEN '$fecha_inicio' AND '$fecha_final' AND metodopago LIKE '%bancolombia%'");


$datos_ventas_leidy_bc = mysqli_fetch_assoc($consulta_datos_leidy_bc);
$monto_leidy_bc = $datos_ventas_leidy_bc['total_leidy_bc'];

$consulta_ventas_leidy_bc = $cnx->query("SELECT count(order_id) as total_leidy_count_bc FROM factura_modificada WHERE order_date BETWEEN '$fecha_inicio' AND '$fecha_final' metodopago LIKE '%bancolombia%'");

$data_leidy_bc = mysqli_fetch_assoc($consulta_ventas_leidy_bc);
$count_leidy_bc = $data_leidy_bc['total_leidy_count_bc'];

//DAVIVIENDA  CALL
$consulta_datos_leidy_dv = $cnx->query("SELECT SUM(total) as total_leidy_dv FROM factura_modificada WHERE order_date BETWEEN '$fecha_inicio' AND '$fecha_final' AND metodopago LIKE '%davivienda%'");


$datos_ventas_leidy_dv = mysqli_fetch_assoc($consulta_datos_leidy_dv);
$monto_leidy_dv = $datos_ventas_leidy_dv['total_leidy_dv'];

$consulta_ventas_leidy_dv = $cnx->query("SELECT count(order_id) as total_leidy_count_dv FROM factura_modificada WHERE order_date BETWEEN '$fecha_inicio' AND '$fecha_final' metodopago LIKE '%davivienda%'");

$data_leidy_dv = mysqli_fetch_assoc($consulta_ventas_leidy_dv);
$count_leidy_dv = $data_leidy_dv['total_leidy_count_dv'];
//contra entrega call 
$consulta_datos_leidy_ce = $cnx->query("SELECT SUM(total) as total_leidy_ce FROM factura_modificada WHERE order_date BETWEEN '$fecha_inicio' AND '$fecha_final' AND metodopago LIKE '%contra%'");


$datos_ventas_leidy_ce = mysqli_fetch_assoc($consulta_datos_leidy_ce);
$monto_leidy_ce = $datos_ventas_leidy_ce['total_leidy_ce'];

$consulta_ventas_leidy_ce = $cnx->query("SELECT count(order_id) as total_leidy_count_ce FROM factura_modificada WHERE order_date BETWEEN '$fecha_inicio' AND '$fecha_final' metodopago LIKE '%contra%'");

$data_leidy_ce = mysqli_fetch_assoc($consulta_ventas_leidy_ce);
$count_leidy_ce = $data_leidy_ce['total_leidy_count_ce'];
//credito
$consulta_datos_leidy_cd = $cnx->query("SELECT SUM(total) as total_leidy_cd FROM factura_modificada WHERE order_date BETWEEN '$fecha_inicio' AND '$fecha_final' AND metodopago LIKE '%credito%'");


$datos_ventas_leidy_cd = mysqli_fetch_assoc($consulta_datos_leidy_cd);
$monto_leidy_cd = $datos_ventas_leidy_cd['total_leidy_cd'];

$consulta_ventas_leidy_cd = $cnx->query("SELECT count(order_id) as total_leidy_count_cd FROM factura_modificada WHERE order_date BETWEEN '$fecha_inicio' AND '$fecha_final' metodopago LIKE '%credito%'");

$data_leidy_cd = mysqli_fetch_assoc($consulta_ventas_leidy_cd);
$count_leidy_cd = $data_leidy_cd['total_leidy_count_cd'];

//efectivo
$consulta_datos_leidy_ef = $cnx->query("SELECT SUM(total) as total_leidy_ef FROM factura_modificada WHERE order_date BETWEEN '$fecha_inicio' AND '$fecha_final' AND metodopago LIKE '%efectivo%'");


$datos_ventas_leidy_ef = mysqli_fetch_assoc($consulta_datos_leidy_ef);
$monto_leidy_ef = $datos_ventas_leidy_ef['total_leidy_ef'];

$consulta_ventas_leidy_ef = $cnx->query("SELECT count(order_id) as total_leidy_count_ef FROM factura_modificada WHERE order_date BETWEEN '$fecha_inicio' AND '$fecha_final' metodopago LIKE '%efectivo%'");

$data_leidy_ef = mysqli_fetch_assoc($consulta_ventas_leidy_ef);
$count_leidy_ef = $data_leidy_ef['total_leidy_count_ef'];

//redes sociales
$consulta_datos_leidy_rd = $cnx->query("SELECT SUM(total) as total_leidy_rd FROM factura_modificada WHERE order_date BETWEEN '$fecha_inicio' AND '$fecha_final' AND canal LIKE '%redes%'");

$datos_ventas_leidy_rd = mysqli_fetch_assoc($consulta_datos_leidy_rd);
$monto_leidy_rd = $datos_ventas_leidy_rd['total_leidy_rd'];

$consulta_ventas_leidy_rd = $cnx->query("SELECT count(order_id) as total_leidy_count_rd FROM factura_modificada WHERE order_date BETWEEN '$fecha_inicio' AND '$fecha_final' canal LIKE '%redes%'");

$data_leidy_rd = mysqli_fetch_assoc($consulta_ventas_leidy_rd);
$count_leidy_rd = $data_leidy_rd['total_leidy_count_rd'];

//datafono 
$consulta_datos_leidy_data = $cnx->query("SELECT SUM(total) as total_leidy_data FROM factura_modificada WHERE order_date BETWEEN '$fecha_inicio' AND '$fecha_final' AND metodopago LIKE '%datafono%'");
...
$consulta_ventas_leidy_data = $cnx->query("SELECT count(order_id) as total_leidy_count_data FROM factura_modificada WHERE order_date BETWEEN '$fecha_inicio' AND '$fecha_final' metodopago LIKE '%datafono%'");

$data_leidy_data = mysqli_fetch_assoc($consulta_ventas_leidy_data);
$count_leidy_data = $data_leidy_data['total_leidy_count_data'];
//mercado libre
$consulta_datos_leidy_ml = $cnx->query("SELECT SUM(total) as total_leidy_ml FROM factura_modificada WHERE order_date BETWEEN '$fecha_inicio' AND '$fecha_final' AND metodopago LIKE '%mercado%'");

$datos_ventas_leidy_ml = mysqli_fetch_assoc($consulta_datos_leidy_ml);
$monto_leidy_ml = $datos_ventas_leidy_ml['total_leidy_ml'];

$consulta_ventas_leidy_ml = $cnx->query("SELECT count(order_id) as total_leidy_count_ml FROM factura_modificada WHERE order_date BETWEEN '$fecha_inicio' AND '$fecha_final' metodopago LIKE '%mercado%'");
...
$consulta_datos_michel = $cnx->query("SELECT SUM(order_total_after_tax) as total_michel FROM factura_orden WHERE order_date BETWEEN '$fecha_inicio' AND '$fecha_final' AND order_receiver_address LIKE '%$michel%' AND metodopago ='$ibague1' AND estado LIKE '%$finalizado%'");


$datos_ventas_michel = mysqli_fetch_assoc($consulta_datos_michel);
$monto_michel = $datos_ventas_michel['total_michel'];

$consulta_ventas_michel = $cnx->query("SELECT count(user_id) as total_michel_count FROM factura_orden WHERE order_date BETWEEN '$fecha_inicio' AND '$fecha_final' AND order_receiver_address LIKE '%$michel%' AND metodopago ='$ibague1' AND estado LIKE '%$finalizado%'");

$data_michel = mysqli_fetch_assoc($consulta_ventas_michel);
$count_michel = $data_michel['total_michel_count'];

//ibague 1 -- elizabeth 
$consulta_datos_eli = $cnx->query("SELECT SUM(order_total_after_tax) as total_eli FROM factura_orden WHERE order_date BETWEEN '$fecha_inicio' AND '$fecha_final' AND order_receiver_address LIKE '%$elizabet%' AND metodopago ='$ibague1' AND estado LIKE '%$finalizado%'");


$datos_ventas_elizabeth = mysqli_fetch_assoc($consulta_datos_eli);
$monto_elizabeth = $datos_ventas_elizabeth['total_eli'];

$consulta_ventas_elizabeth = $cnx->query("SELECT count(user_id) as total_eli_count FROM factura_orden WHERE order_date BETWEEN '$fecha_inicio' AND '$fecha_final' AND order_receiver_address LIKE '%$elizabet%' AND metodopago ='$ibague1' AND estado LIKE '%$finalizado%'");
...
$consulta_datos_diego = $cnx->query("SELECT SUM(order_total_after_tax) as total_diego FROM factura_orden WHERE order_date BETWEEN '$fecha_inicio' AND '$fecha_final' AND order_receiver_address LIKE '%$diego%' AND metodopago ='$ibague1' AND estado LIKE '%$finalizado%'");


$datos_ventas_diego = mysqli_fetch_assoc($consulta_datos_diego);
$monto_diego = $datos_ventas_diego['total_diego'];

$consulta_ventas_diego = $cnx->query("SELECT count(user_id) as total_diego_count FROM factura_orden WHERE order_date BETWEEN '$fecha_inicio' AND '$fecha_final' AND order_receiver_address LIKE '%$diego%' AND metodopago ='$ibague1' AND estado LIKE '%$finalizado%'");
...
//ibague 1 -- linda
$consulta_datos_linda = $cnx->query("SELECT SUM(order_total_after_tax) as total_linda FROM factura_orden WHERE order_date BETWEEN '$fecha_inicio' AND '$fecha_final' AND order_receiver_address LIKE '%$linda%' AND metodopago ='$ibague1' AND estado LIKE '%$finalizado%'");


$datos_ventas_linda = mysqli_fetch_assoc($consulta_datos_linda);
$monto_linda = $datos_ventas_linda['total_linda'];

$consulta_ventas_linda = $cnx->query("SELECT count(user_id) as total_linda_count FROM factura_orden WHERE order_date BETWEEN '$fecha_inicio' AND '$fecha_final' AND order_receiver_address LIKE '%$linda%' AND metodopago ='$ibague1' AND estado LIKE '%$finalizado%'");
...
$consulta_datos_leidyj = $cnx->query("SELECT SUM(order_total_after_tax) as total_leidyj FROM factura_orden WHERE order_date BETWEEN '$fecha_inicio' AND '$fecha_final' AND order_receiver_address LIKE '%$leidy_j%' AND metodopago ='$ibague2' AND estado LIKE '%$finalizado%'");


$datos_ventas_leidyj = mysqli_fetch_assoc($consulta_datos_leidyj);
$monto_leidyj = $datos_ventas_leidyj['total_leidyj'];

$consulta_ventas_leidyj = $cnx->query("SELECT count(user_id) as total_leidyj_count FROM factura_orden WHERE order_date BETWEEN '$fecha_inicio' AND '$fecha_final' AND order_receiver_address LIKE '%$leidy_j%' AND metodopago ='$ibague2' AND estado LIKE '%$finalizado%'");
...
//ibague 2 -- angie
$consulta_datos_angie = $cnx->query("SELECT SUM(order_total_after_tax) as total_angie FROM factura_orden WHERE order_date BETWEEN '$fecha_inicio' AND '$fecha_final' AND order_receiver_address LIKE '%$angie%' AND metodopago ='$ibague2' AND estado LIKE '%$finalizado%'");


$datos_ventas_angie = mysqli_fetch_assoc($consulta_datos_angie);
$monto_angie = $datos_ventas_angie['total_angie'];

$consulta_ventas_angie = $cnx->query("SELECT count(user_id) as total_angie_count FROM factura_orden WHERE order_date BETWEEN '$fecha_inicio' AND '$fecha_final' AND order_receiver_address LIKE '%$angie%' AND metodopago ='$ibague2' AND estado LIKE '%$finalizado%'");
