...
function fetch_customer_data($connect)
{
  ...
  $solicitud_anular = $cnx->query("SELECT * FROM solicitud_anular INNER JOIN factura_orden ON factura_orden.order_id = solicitud_anular.order_id WHERE order_date BETWEEN '$today' AND '$tomo'");

  //consultando con cuanto dinero comenzo el dia cada punto de venta
  $dinero_inicial = $cnx->query("SELECT * FROM start_day WHERE order_date BETWEEN '$today' AND '$tomo'");

  //consultando gastos y novedades 
  $gastos_novedades = $cnx->query("SELECT * FROM novedades_gastos WHERE order_date BETWEEN '$today' AND '$tomo'");




  //consultando la cantidad de Cotizaciones mostrador
  $resultado_count = $cnx->query("SELECT count(*) as total from factura_orden WHERE order_date BETWEEN '$hoy' AND '$ma���ana' AND metodopago = '$mostrador' AND estado !='$anular'");
  $data = mysqli_fetch_assoc($resultado_count);
  $cuenta_mostrador = $data['total'];
  //calculando la cantidad de cotizaciones callcenter
  $resultado_count_call = $cnx->query("SELECT count(*) as total_call from factura_modificada WHERE order_date BETWEEN '$hoy' AND '$ma���ana' AND punto_pago != '$mostrador' ");
  ...
  $resultado_count_d1 = $cnx->query("SELECT count(*) as total_d1 from factura_orden WHERE order_date BETWEEN '$hoy' AND '$ma���ana' AND metodopago = '$mostrador_d1' AND estado ='$status'");
  $data_d1 = mysqli_fetch_assoc($resultado_count_d1);
  $cuenta_d1 = $data_d1['total_d1'];
  //calculando la cantidad de ibague 1
  $resultado_count_ib1 = $cnx->query("SELECT count(*) as total_ib1 from factura_orden WHERE order_date BETWEEN '$hoy' AND '$ma���ana' AND metodopago = '$ibague1' AND estado ='$status'");
  $data_ib1 = mysqli_fetch_assoc($resultado_count_ib1);
  $cuenta_ib1 = $data_ib1['total_ib1'];
  //calculando la cantidad de ibague 2
  $resultado_count_ib2 = $cnx->query("SELECT count(*) as total_ib2 from factura_orden WHERE order_date BETWEEN '$hoy' AND '$ma���ana' AND metodopago = '$ibague2' AND estado ='$status'");
  ...
  $query_cc_bancolombia = $cnx->query("SELECT sum(total) as total_call_bancolombia from factura_modificada WHERE order_date BETWEEN '$hoy' AND '$ma���ana' AND metodopago LIKE '%$callcenter%' AND punto_pago != '$mostrador'"); // bancolombia
  $data_bc_call = mysqli_fetch_assoc($query_cc_bancolombia);
  $cuenta_call_bancolombia = $data_bc_call['total_call_bancolombia'];

  $query_cc_davivienda = $cnx->query("SELECT sum(total) as total_call_davivienda from factura_modificada WHERE order_date BETWEEN '$hoy' AND '$ma���ana' AND metodopago LIKE '%$davivienda%' AND punto_pago != '$mostrador'"); // davivienda
  $data_dv_call = mysqli_fetch_assoc($query_cc_davivienda);
  $cuenta_call_davivienda = $data_dv_call['total_call_davivienda'];

  $query_cc_credito = $cnx->query("SELECT sum(total) as total_call_credito from factura_modificada WHERE order_date BETWEEN '$hoy' AND '$ma���ana' AND metodopago LIKE '%$credito%' AND punto_pago != '$mostrador'"); //credito
  $data_cd_call = mysqli_fetch_assoc($query_cc_credito);
  $cuenta_call_credito = $data_cd_call['total_call_credito'];

  $query_cc_contra = $cnx->query("SELECT sum(total) as total_call_contra from factura_modificada WHERE order_date BETWEEN '$hoy' AND '$ma���ana' AND metodopago LIKE '%$contraentrega%' AND punto_pago != '$mostrador'"); // contra entrega
  $data_ct_call = mysqli_fetch_assoc($query_cc_contra);
  $cuenta_call_contra = $data_ct_call['total_call_contra'];

  $query_cc_mercado = $cnx->query("SELECT sum(total) as total_call_mercado from factura_modificada WHERE order_date BETWEEN '$hoy' AND '$ma���ana' AND metodopago LIKE '%$mercado_libre%' AND punto_pago != '$mostrador'"); // mercado libre
  $data_md_call = mysqli_fetch_assoc($query_cc_mercado);
  $cuenta_call_mercado = $data_md_call['total_call_mercado'];


  $query_cc_redes = $cnx->query("SELECT sum(total) as total_call_redes from factura_modificada WHERE order_date BETWEEN '$hoy' AND '$ma���ana' AND canal LIKE '%$redes%' AND punto_pago != '$mostrador'"); // redes sociales
  $data_rd_call = mysqli_fetch_assoc($query_cc_redes);
  $cuenta_call_redes = $data_rd_call['total_call_redes'];

  $query_cc_datafono = $cnx->query("SELECT sum(total) as total_call_datafono from factura_modificada WHERE order_date BETWEEN '$hoy' AND '$ma���ana' AND metodopago LIKE '%$datafono%' AND punto_pago != '$mostrador'"); // datafono (ventas mostrador)
  $data_rd_datafono = mysqli_fetch_assoc($query_cc_datafono);
  $cuenta_call_datafono = $data_rd_datafono['total_call_datafono'];

  //efectivo
  $query_cc_mostrador_efectivo = $cnx->query("SELECT sum(total) as total_call_efectivo_mostrador from factura_modificada WHERE order_date BETWEEN '$hoy' AND '$ma���ana' AND metodopago LIKE '%$efectico%' AND punto_pago = '$mostrador'"); // efectivo (ventas mostrador)
  ...
  $query_mostrador_bancolombia = $cnx->query("SELECT sum(order_total_after_tax) as total_mostrador_bancolombia from factura_orden WHERE order_date BETWEEN '$hoy' AND '$ma���ana' AND metodopago LIKE '%$mostrador%' AND metodo_de_pago LIKE '%$callcenter%' AND estado !='$anular'"); // bancolombia
  ...
  $query_mostrador_davivienda = $cnx->query("SELECT sum(order_total_after_tax) as total_mostrador_davivienda from factura_orden WHERE order_date BETWEEN '$hoy' AND '$ma���ana' AND metodopago LIKE '%$mostrador%' AND metodo_de_pago LIKE '%$davivienda%' AND estado !='$anular'"); // davivienda
  ...
  $query_mostrador_efectivo = $cnx->query("SELECT sum(order_total_after_tax) as total_mostrador_efectivo from factura_orden WHERE order_date BETWEEN '$hoy' AND '$ma���ana' AND metodopago LIKE '%$mostrador%' AND metodo_de_pago LIKE '%$efectico%' AND estado !='$anular'"); //efectivo 
  ...
  $query_mostrador_datafono = $cnx->query("SELECT sum(order_total_after_tax) as total_mostrador_datafono from factura_orden WHERE order_date BETWEEN '$hoy' AND '$ma���ana' AND metodopago LIKE '%$mostrador%' AND metodo_de_pago LIKE '%$datafono%' AND estado !='$anular'"); // datafono 
  ...
  $query_mostradord1_bancolombia = $cnx->query("SELECT sum(order_total_after_tax) as total_mostradord1_bancolombia from factura_orden WHERE order_date BETWEEN '$hoy' AND '$ma���ana' AND metodopago LIKE '%$mostrador_d1%' AND metodo_de_pago LIKE '%$callcenter%' AND estado !='$anular'"); // bancolombia
  ...
  $query_mostradord1_davivienda = $cnx->query("SELECT sum(order_total_after_tax) as total_mostradord1_davivienda from factura_orden WHERE order_date BETWEEN '$hoy' AND '$ma���ana' AND metodopago LIKE '%$mostrador_d1%' AND metodo_de_pago LIKE '%$davivienda%' AND estado !='$anular'"); // davivienda
  ...
  $query_mostradord1_efectivo = $cnx->query("SELECT sum(order_total_after_tax) as total_mostradord1_efectivo from factura_orden WHERE order_date BETWEEN '$hoy' AND '$ma���ana' AND metodopago LIKE '%$mostrador_d1%' AND metodo_de_pago LIKE '%$efectico%' AND estado !='$anular'"); //efectivo 
  ...
  $query_mostradord1_datafono = $cnx->query("SELECT sum(order_total_after_tax) as total_mostradord1_datafono from factura_orden WHERE order_date BETWEEN '$hoy' AND '$ma���ana' AND metodopago LIKE '%$mostrador_d1%' AND metodo_de_pago LIKE '%$datafono%' AND estado !='$anular'"); // datafono 
  ...
  $query_ibague_bancolombia = $cnx->query("SELECT sum(order_total_after_tax) as total_ibague_bancolombia from factura_orden WHERE order_date BETWEEN '$hoy' AND '$ma���ana' AND metodopago LIKE '%$ibague1%' AND metodo_de_pago LIKE '%$callcenter%' AND estado !='$anular'"); // bancolombia
  ...
  $query_ibague_davivienda = $cnx->query("SELECT sum(order_total_after_tax) as total_ibague_davivienda from factura_orden WHERE order_date BETWEEN '$hoy' AND '$ma���ana' AND metodopago LIKE '%$ibague1%' AND metodo_de_pago LIKE '%$davivienda%' AND estado !='$anular'"); // davivienda
  $data_dv_ibague = mysqli_fetch_assoc($query_ibague_davivienda);
  $cuenta_ibague_davivienda = $data_dv_ibague['total_ibague_davivienda'];

  $query_ibague_efectivo = $cnx->query("SELECT sum(order_total_after_tax) as total_ibague_efectivo from factura_orden WHERE order_date BETWEEN '$hoy' AND '$ma���ana' AND metodopago LIKE '%$ibague1%' AND metodo_de_pago LIKE '%$efectico%' AND estado !='$anular'"); //efectivo 
  $data_cd_ibague = mysqli_fetch_assoc($query_ibague_efectivo);
  $cuenta_ibague_efectivo = $data_cd_ibague['total_ibague_efectivo'];

  $query_ibague_datafono = $cnx->query("SELECT sum(order_total_after_tax) as total_ibague_datafono from factura_orden WHERE order_date BETWEEN '$hoy' AND '$ma���ana' AND metodopago LIKE '%$ibague1%' AND metodo_de_pago LIKE '%$datafono%' AND estado !='$anular'"); // datafono 
  ...
  $query_ibague2_bancolombia = $cnx->query("SELECT sum(order_total_after_tax) as total_ibague2_bancolombia from factura_orden WHERE order_date BETWEEN '$hoy' AND '$ma���ana' AND metodopago LIKE '%$ibague2%' AND metodo_de_pago LIKE '%$callcenter%' AND estado !='$anular'"); // bancolombia
  ...
  $query_ibague2_davivienda = $cnx->query("SELECT sum(order_total_after_tax) as total_ibague2_davivienda from factura_orden WHERE order_date BETWEEN '$hoy' AND '$ma���ana' AND metodopago LIKE '%$ibague2%' AND metodo_de_pago LIKE '%$davivienda%' AND estado !='$anular'"); // davivienda
  ...
  $query_ibague2_efectivo = $cnx->query("SELECT sum(order_total_after_tax) as total_ibague2_efectivo from factura_orden WHERE order_date BETWEEN '$hoy' AND '$ma���ana' AND metodopago LIKE '%$ibague2%' AND metodo_de_pago LIKE '%$efectico%' AND estado !='$anular'"); //efectivo 
  $data_cd_ibague2 = mysqli_fetch_assoc($query_ibague2_efectivo);
  $cuenta_ibague2_efectivo = $data_cd_ibague2['total_ibague2_efectivo'];

  $query_ibague2_datafono = $cnx->query("SELECT sum(order_total_after_tax) as total_ibague2_datafono from factura_orden WHERE order_date BETWEEN '$hoy' AND '$ma���ana' AND metodopago LIKE '%$ibague2%' AND metodo_de_pago LIKE '%$datafono%' AND estado !='$anular'"); // datafono 
  ...
  $query_mostrador_F_E = $cnx->query("SELECT sum(monto) as total_mostrador_F_E from finish_day WHERE order_date BETWEEN '$today' AND '$tomo' AND punto_venta LIKE '%$mostrador%'"); // SUMA DEL MONTO MOSTRADOR PRINCIPAL
  $mostrador_F_E = mysqli_fetch_assoc($query_mostrador_F_E);
  $suma_mostrador_F_E = $mostrador_F_E['total_mostrador_F_E'];

  $query_ibague1_F_E = $cnx->query("SELECT sum(monto) as total_ibague1_F_E from finish_day WHERE order_date BETWEEN '$today' AND '$tomo' AND punto_venta LIKE '%$ibague1%'"); // SUMA DEL MONTO MOSTRADOR IBAGUE
  $mostrador_ibague1_F_E = mysqli_fetch_assoc($query_ibague1_F_E);
  $suma_ibague1_F_E = $mostrador_ibague1_F_E['total_ibague1_F_E'];

  $query_ibague2_F_E = $cnx->query("SELECT sum(monto) as total_ibague2_F_E from finish_day WHERE order_date BETWEEN '$today' AND '$tomo' AND punto_venta LIKE '%$ibague2%'"); // SUMA DEL MONTO MOSTRADOR IBAGUE 2
  $mostrador_ibague2_F_E = mysqli_fetch_assoc($query_ibague2_F_E);
  $suma_ibague2_F_E = $mostrador_ibague2_F_E['total_ibague2_F_E'];

  $query_d1_F_E = $cnx->query("SELECT sum(monto) as total_d1_F_E from finish_day WHERE order_date BETWEEN '$today' AND '$tomo' AND punto_venta LIKE '%$mostrador_d1%'"); // SUMA DEL MONTO MOSTRADOR IBAGUE 2
