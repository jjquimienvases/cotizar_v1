...
function formatear($num){
	...
	$sentencia_select=$con->prepare('SELECT * FROM `producto_av` WHERE id_categoria != 4 AND id_categoria != 13 AND id_categoria != 21');
	...
	<div class="contenedor">
      ...
      <?php
        ...
        ?>
          ...
          <td> <?php
              $monto_invertido = $costo * $stock;
              $monetario = 4500000;
            if($monto_invertido > $monetario){
                       echo '<span   style="background-color:#E65100;text-align:center;">';
                       echo formatear($monto_invertido);
                       echo '</span>';
