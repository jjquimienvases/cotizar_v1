            ...
            <table class="table table-striped table-bordered">
                <thead>
                 ...
                 <hr>
                    ...
                    <tr>
                        <th colspan="3">Deuda</th>
                        <th colspan="3">Monto abonado</th>
                        <th colspan="3">Cotizaciones</th>
                        <th colspan="3">Cotizaciones abondas</th>
                    </tr>
                    <tr>

                       <td colspan="3"><?= formatear($monto_cd); ?></td>
                       <td colspan="3"><?= formatear($monto_ab); ?></td>
                       <td colspan="3"><?= $count_cd; ?></td>
                       <td colspan="3"><?= $count_abonos; ?></td>
                    </tr>
             <tr> <td><button id="info_credito" onclick="detalles()" class="btn btn-info">Ver detalles de abonos</button> </td> </tr>   
