...
$consulta_datos_leidy = $conexion->query("SELECT SUM(total) as total_leidy FROM factura_orden fo INNER JOIN factura_modificada fm ON fo.order_id = fm.order_id WHERE DATE(fo.order_date) BETWEEN '$fecha_inicio' AND '$fecha_final' AND (fm.estado LIKE '%solicitud%' OR fm.estado LIKE '%finalizado%' OR fm.estado LIKE '%alistamiento%')");
...
$consulta_data_c = $conexion->query("SELECT * FROM factura_orden fo INNER JOIN factura_modificada fm ON fo.order_id = fm.order_id WHERE DATE(fo.order_date) BETWEEN '$fecha_inicio' AND '$fecha_final' AND (fm.estado LIKE '%solicitud%' OR fm.estado LIKE '%finalizado%' OR fm.estado LIKE '%alistamiento%') AND fm.metodopago LIKE '%contra%'");
...
$consulta_data_rd = $conexion->query("SELECT * FROM factura_orden fo INNER JOIN factura_modificada fm ON fo.order_id = fm.order_id WHERE DATE(fo.order_date) BETWEEN '$fecha_inicio' AND '$fecha_final' AND (fm.estado LIKE '%solicitud%' OR fm.estado LIKE '%finalizado%' OR fm.estado LIKE '%alistamiento%') AND fm.canal LIKE '%redes%'");
...
$consulta_data_tv = $conexion->query("SELECT * FROM factura_orden fo INNER JOIN factura_modificada fm ON fo.order_id = fm.order_id WHERE DATE(fo.order_date) BETWEEN '$fecha_inicio' AND '$fecha_final' AND (fm.estado LIKE '%solicitud%' OR fm.estado LIKE '%finalizado%' OR fm.estado LIKE '%alistamiento%') AND fm.canal LIKE '%tienda%'");
...
$consulta_data_cl = $conexion->query("SELECT * FROM factura_orden fo INNER JOIN factura_modificada fm ON fo.order_id = fm.order_id WHERE DATE(fo.order_date) BETWEEN '$fecha_inicio' AND '$fecha_final' AND (fm.estado LIKE '%solicitud%' OR fm.estado LIKE '%finalizado%' OR fm.estado LIKE '%alistamiento%') AND fm.canal LIKE '%call%'");
...
$get_data_credito = $conexion->query("SELECT * FROM factura_orden fo INNER JOIN factura_modificada fm ON fo.order_id = fm.order_id WHERE DATE(fo.order_date) BETWEEN '$fecha_inicio' AND '$fecha_final' AND (fm.estado LIKE '%solicitud%' OR fm.estado LIKE '%finalizado%' OR fm.estado LIKE '%alistamiento%') AND fm.metodopago LIKE '%credito%'");
                ...
                <thead>
                 ...
                 <hr>
                  ...
                  <div class="credito" id="credito">                    
                    ...
                    <?php  $cotizacion = $fila['order_id'];  $pdf = "<button class='btn btn-warning'> <a href='../print_invoice.php?invoice_id=".$cotizacion."' target='_blank'>PDF</a></button>";?>
