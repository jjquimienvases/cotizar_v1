...
$sel = $cnx->query("SELECT * FROM files INNER JOIN factura_orden ON factura_orden.order_id = files.order_id WHERE files.estado = '$status' OR files.estado = '$status2'");
          ...
          <?php foreach ($res as $val) { ?>
            <form class="" action="" method="post">
              <tr>
                ...
                <td>
                  <center> <?php echo $val['order_receiver_name'] ?> </center>
                </td>
                <td>
                ...
                <td>
                  <center> <?php echo $val['id_punto_venta'] ?> </center>
                </td>
                <td>
          ...
          <form enctype="multipart/form-data" id="form1">
            ...
            <div style="text-align: center;">
              <select id="buscarcliente" style="width: 100%" name="cotizacion">
                ...
                <?php
                $query = $cnx->query("SELECT * FROM files WHERE estado = 'pendiente' or estado = 's_factura' ORDER BY order_date DESC ");
