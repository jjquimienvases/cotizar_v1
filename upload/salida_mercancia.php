...
$sel = $cnx->query("SELECT * FROM files WHERE estado LIKE '%$status%' AND order_date BETWEEN '$hoy' AND '$tomorrow'");
// $sel = $cnx->query("SELECT * FROM files WHERE estado LIKE '%$status%' AND order_date BETWEEN '$demo_fecha' AND '$demo_fecha_2' ");
            ...
            <table class="table table-hover table-bordered" width="100%">
                ...
                <tbody>
                    <?php foreach ($res as $val) { ?>
                        ...
                        // $cnxsulta_total = "SELECT * FROM factura_orden WHERE order_id =$cotizacion";
                        ?>
                    ...
                    <form enctype="multipart/form-data" id="form1">
                        ...
                        <div style="text-align: center;">
                            <select id="buscarcliente" style="width: 100%" name="cotizacion" class="form-control">
                                ...
                                <?php
                                $query = $cnx->query("SELECT * FROM files WHERE estado LIKE '%finalizado%' AND order_date BETWEEN '$hoy' AND '$tomorrow' ORDER BY order_date DESC ");
