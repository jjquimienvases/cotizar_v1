<div id="openModal" class="modalDialog">
	<div>
		...
		<div class="modal_mensaje">
			<br>
			<center><h3>Escoger una fragancia </h3> </center>
			<hr>
...
<td><input type="number" name="cantidad" id="cantidad" onkeyup="return calcularTotal()"></td>
</tr>
</tbody>
<tfoot>
...
<td><div style="text-align: center;">
 <label for="">Escoger un envase: </label>
...
<label for="">Este producto contiene:</label> <input onlyread type="number" name="crema4" id="crema4" value="3" placeholder="cantidad" readonly>
<label for="">Cuesta:</label> <input type="number" name="preciocrema4" id="preciocrema4" value="7000" readonly>
<label for="">Cuantos deseas llevar:</label> <input type="number" name="cantidadcrema4" id="cantidadcrema4" onkeyup="return calcularTotalCrema60()" >
</div>
<!-- 120 ml -->
<div class="" id="crema120"  style="display: none;">
	<button type="" name="closecm120" id="closecm120">X</button>

<label for="">Este producto contiene:</label> <input onlyread type="number" name="crema5" id="crema5" value="6" placeholder="cantidad" readonly>
<label for="">Cuesta:</label> <input type="number" name="preciocrema5" id="preciocrema5" value="10000" readonly>
<label for="">Cuantos deseas llevar:</label> <input type="number" name="cantidadcrema5" id="cantidadcrema5" onkeyup="return calcularTotalCrema120()" >
</div>
<!-- 250 -->
<div class="" id="crema250"  style="display: none;">
	<button type="" name="closecm250" id="closecm250">X</button>

<label for="">Este producto contiene:</label> <input onlyread type="number" name="crema6" id="crema6" value="10" placeholder="cantidad" readonly>
<label for="">Cuesta:</label> <input type="number" name="preciocrema3" id="preciocrema6" value="15000" readonly>
<label for="">Cuantos deseas llevar:</label> <input type="number" name="cantidadcrema6" id="cantidadcrema6" onkeyup="return calcularTotalCrema250()" >
</div>
...
<button type="button" name="button" id="try" class="btn btn-success">Agregar producto</button>
