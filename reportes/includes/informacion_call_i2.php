<div class="tab-pane fade show" id="call_ibague2" role="tabpanel" aria-labelledby="home-tab">
<div class="tab-content" id="myTabContent">
            <div :class="index === 0 ? 'tab-pane fade show active' : 'tab-pane fade show'" :id="items_" role="tabpanel" aria-labelledby="home-tab" v-for="items_, index in info_call_i2">
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    ...
                    <li class="nav-items_" role="presentation">
                        <button class="nav-link" id="profile-tab" data-bs-toggle="tab" :data-bs-target="`#${items_}-pagos`" type="button" role="tab" aria-controls="${$items_}-pagos" aria-selected="false">Metodos De Pago</button>
                    </li>
...
<div class="tab-pane fade show active" :id="`${items_}-finalizada`" role=" tabpanel" aria-labelledby="home-tab">
            <table class="table table-bordered">
                <thead>
                    <tr>
                        <th colspan="8" class="text-center"> Cotizaciones CallCenter/Ibague 2 Finalizadas</th>
                    </tr>
                    <tr>
        ...
        <div class="tab-pane fade show" :id="`${items_.pendiente}`" role="tabpanel" aria-labelledby="home-tab">
            <table class="table table-bordered">
                <thead>
                    <tr>
                        <th colspan="8" class="text-center"> Cotizaciones CallCenter/Ibague 2 Pendientes</th>
                    </tr>
                    <tr>
        ...
        <div class="tab-pane fade show" :id="`${items_.no_recoge}`" role="tabpanel" aria-labelledby="home-tab">
            <table class="table table-bordered">
                <thead>
                    <tr>
                        <th colspan="8" class="text-center"> Cotizaciones CallCenter/Ibague 2 No Recogieron</th>
                    </tr>
                    <tr>
