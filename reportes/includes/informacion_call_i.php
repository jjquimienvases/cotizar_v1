<div class="tab-pane fade show" id="call_ibague" role="tabpanel" aria-labelledby="home-tab">
<div class="tab-content" id="myTabContent">
            <div :class="index === 0 ? 'tab-pane fade show active' : 'tab-pane fade show'" :id="items_" role="tabpanel" aria-labelledby="home-tab" v-for="items_, index in info_call_i">
...
<div class="tab-pane fade show active" :id="`${items_}-finalizada`" role=" tabpanel" aria-labelledby="home-tab">
            <table class="table table-bordered">
                <thead>
                    <tr>
                        <th colspan="8" class="text-center"> Cotizaciones CallCenter/Ibague Finalizadas</th>
                    </tr>
                    <tr>
        ...
        <div class="tab-pane fade show" :id="`${items_.pendiente}`" role="tabpanel" aria-labelledby="home-tab">
            <table class="table table-bordered">
                <thead>
                    <tr>
                        <th colspan="8" class="text-center"> Cotizaciones CallCenter/Ibague Pendientes</th>
                    </tr>
                    <tr>
        ...
        <div class="tab-pane fade show" :id="`${items_.no_recoge}`" role="tabpanel" aria-labelledby="home-tab">
            <table class="table table-bordered">
                <thead>
                    <tr>
                        <th colspan="8" class="text-center"> Cotizaciones CallCenter/Ibague No Recogieron</th>
                    </tr>
                    <tr>
