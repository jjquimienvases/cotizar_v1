...
<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
    <h2 class="title">Cotizaciones mostrador</h2>
...
<select name="metodopago" class="pagoselection">
 ...
 <option value="mostradorjj"selected>mostrador JJ</option>
 	             ...
 	             <td>
 						   ...
 						   <td><input type="text"  placeholder="Categoria" name="idCategoria[]" size="2" id="idCategoria_1" value="" style="text-align: center; width: 100%;"></td>
 							 <td><input type="text"  placeholder="ID producto" name="productCode[]" size="8" id="productCode_1" value="" style="text-align: center; width: 100%;"></td>
 	 						 ...
 	 						 <td><input type="text"  placeholder="Producto" name="productStock[]" size="15" id="productStock_1" value="" style="text-align: center; width: 100%;"></td>
 	 						 <td><input type="text"  placeholder="Producto" name="productUnidad[]" size="15" id="productUnidad_1" value="" style="text-align: center; width: 100%;"></td>
	...
	$(document).ready(function(){
		$('#guardando').click(function(){
			...
			$.ajax({
             ...
             window.location="search_mostrador/index.php";
