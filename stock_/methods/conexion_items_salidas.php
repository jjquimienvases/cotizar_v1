...
switch ($fun) {
    case 'Q1':
        $id = $_POST['codigo_item'];
        $date_inicio = $_POST['inicio'];
$date_final = $_POST['fin'];
        ...
        $sql = "SELECT SUM(cantidad) as Total FROM traspasos WHERE DATE(order_date) BETWEEN '$date_inicio' AND '$date_final' AND codigo = $id AND bodega_salida = 'producto_av' AND estado LIKE '%finalizado%'";
