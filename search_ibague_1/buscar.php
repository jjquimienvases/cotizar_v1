...
function formatear($num){
    ...
    if ($resultado->num_rows>0) {
      ...
      $link = "<button> <a href='../print_invoice.php?invoice_id=".$cotizacion."' target='_blank'>PDF</a></button>";
    	$url ="<button> <a href='../edit_invoice.php?update_id=".$cotizacion."' target='_blank'>Editar</a></button>";
