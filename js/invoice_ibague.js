...
$(document).ready(function(){
  ...
  function elem(element,args){
    let edens = new Object;//osea este xD
  ...
  $(document).on('click', '#addRows', function() {
    ...
    let tr = elem('tr',{
      ...
      td:[
        ...
        {
          innerHTML:elem('input',{
            attr:{placeholder:"Cantidad",size:2,name:'quantity[]'},
            style:{width:'100%'},
            id:'quantity_'+count,
            on:{
...
// potes actualizado
  ...
  total = sub_total + 50;
    ...
    valor = parseInt(price);
    var total = valor;
}else if(quantity > 1 && quantity < 12 && categoria == 9 ){ //envases de perfumeria ibague 
  valor = parseInt(price);
  var  posibleiva = valor * 0.19;
  iva = parseInt(posibleiva);
  iva = parseInt(iva);
  ...
  sub_total = (porcentaje + coniva);
  total = sub_total + 50;
 }else if(quantity > 100 && quantity < 1000 && categoria == 9 ){
  valor = parseInt(price);
  var  posibleiva = valor * 0.19;
  iva = parseInt(posibleiva);
  iva = parseInt(iva);
