                    ...
                    innerHTML: (select = elem("select", {
                        ...
                        on: {
                            onchange: function(evt) {
                                var tabla = $("#tabla").val();
                                $.ajax({
                                        url: "methods/conexion_prueba.php",
                                        type: "POST",
                                        dataType: "json",
                                        data: {
                                            key: "Q1",
...
function calculateTotal(id1) {
    ...
    $("[id^='result_" + id1 + "']").each(function() {
        ...
        if (!quantity) {
            ...
            var total = galon;
        } else if (categoria == 10 && quantity >= 12 && quantity < 100) {
            var lechera = vl * quantity;

            var total = lechera;
        } else if (categoria == 10 && quantity >= 100 && quantity < 1000) {
            var valorsiniva = price * quantity;
            ...
            var total = porcentaje + coniva;
        } else if (categoria == 10 && quantity >= 1000) {
            var valorsiniva = price * quantity;
            ...
            var total = etiqueta;
        } else if ($(".itemRous").prop("checked") && categoria != 4) {
            var vixc = price * quantity;
            ...
            var total = coniva + porcentaje;
        } else if ($(".itemRows").prop("checked") && quantity < 35) {
            /*aqui inicia perfumeria ibague*/
        ...
        } else if ($(".cEspeciales").prop("checked") && categoria == 4) {
        ...
        if ($(".cEspeciales").prop("checked") && categoria == 4) {
