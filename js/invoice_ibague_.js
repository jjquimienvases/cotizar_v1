                    ...
                    innerHTML: (select = elem("select", {
                        ...
                        on: {
                            onchange: function(evt) {
                                $.ajax({
                                        url: "methods/conexion_ibague.php",
                                        type: "POST",
                                        dataType: "json",
                                        data: {
                                            key: "Q1",
...
console.log(tipo_cliente);    
  ...
  if(undefined==id1) {return;}
    ...
    //   var price = $('#price_'+id1).val();
      ...
      if(cedula == 809012325 && codigo == 596726){var price = 3400;}
...
// productos puntoquimico 
  ...
  sub_total = (porcentaje + coniva);
  total = sub_total;
 }else if($(".price_docena").prop("checked") && quantity > 0){
       valor = parseInt(price);
  var  posibleiva = valor * 0.19;
  iva = parseInt(posibleiva);
  iva = parseInt(iva);
...
//   sub_total = (porcentaje + coniva);
  ...
  sub_total = (porcentaje + coniva);
  total = sub_total;
 }else if($(".mb").prop("checked") && categoria == 4 && quantity < 250){
       valor = price /1000;
  iva = valor * 0.19;
 coniva = valor + iva;
 porcentaje = coniva * 0.50;
 sub_total = porcentaje + coniva;
 total = sub_total;
 }else if($(".mb").prop("checked") && categoria == 4 && quantity > 249 ){
 valor = price /1000;
 iva = valor * 0.19;
 coniva = valor + iva;
 porcentaje = coniva * 0.30;
 ...
 total = sub_total;
  console.log("total gramos"+ total);
}else if(categoria == 40 && quantity == 125){
      var feromonas = 160;
      var total = feromonas;
    }else if(categoria == 40 && quantity == 250){
      var feromonas = 152;
      var total = feromonas;
    }else if(categoria == 40 && quantity ==500){
      var feromonas = 140;
      var total = feromonas;
    }else if(categoria == 40 && quantity == 1000){
      var feromonas = 100;
      var total = feromonas;
    }
  ...
  sub_total = (porcentaje + coniva);
  total = sub_total + 50;
}//aqui vamos a imprimir el tapon aguardientero
else if(codigo == 859 && quantity <=11){
  valor = parseInt(price);
  var  posibleiva = valor * 0.19;
  iva = parseInt(posibleiva);
  iva = parseInt(iva);
  ...
  sub_total = (porcentaje + coniva);
  total = sub_total + 4;
}else if(codigo == 859 && quantity >= 12 && quantity <=99){
  valor = parseInt(price);
  posibleiva = valor * 0.19;
  iva = parseInt(posibleiva);
  iva = parseInt(iva);
  ...
  sub_total = (porcentaje + coniva);
  total = sub_total + 4;
}else if(codigo == 859 && quantity >= 100  && quantity < 999){
  valor = parseInt(price);
  posibleiva = valor * 0.19;
  iva = parseInt(posibleiva);
  iva = parseInt(iva);
  ...
  sub_total = (porcentaje + coniva);
  total = sub_total + 4;
}else if(codigo == 859 && quantity > 999){
  valor = parseInt(price);
  posibleiva = valor * 0.19;
  iva = parseInt(posibleiva);
  iva = parseInt(iva);
...
//AQUI VAMOS A IMPRMIR LAS TAPAS
 ...
 var demo_quantity = 0;
      ...
      if (undefined==total) {total = 0;}
       ...
       }else if($(".mb").prop("checked") && categoria == 4){
           quantity = quantity / 2; 
           demo_total = parseInt(96)*quantity;
           console.log("cantidad marlon"+quantity)
           totales = (total * quantity)+demo_total;
           
            unitario_marlon = parseFloat(totales / (quantity));
   ...
   if(sumaperfumeria !=0){mytotalperfumeria = sumaperfumeria.reduce(function(a,b){return a+b})}else{
    ...
    if($(".mb").prop("checked") && categoria == 4){
        document.getElementById("unitario_"+id1).value= (unitario_marlon).toFixed(2);
    }else if(categoria == 4){
