...
function mensa(id, fila) {
    ...
    $("#Capacidad_" + fila).select2();
     ...
     console.log("El cliente es" + tipo_cliente);
    if (tipo_cliente == "Distribuidores") {
        // distibudores
        switch (valor) {
            case 1:
                $.ajax({
            ...
            case 6:
                ...
                $.ajax({
                    ...
                    $.ajax({
                        url: "methods/conexion_prueba.php",
                        type: "POST",
                        data: { key: "buscarEnvases", tabla: tabla },
                    }).done(function(a) {
                        console.log(a);
                        $("#a_" + fila).html(a);
