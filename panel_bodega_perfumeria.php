...
$result = $cnx->query("SELECT count(*) as total from files WHERE estado = '$alistamiento' AND order_date BETWEEN '$demo_fecha' AND '$demo_fecha_2' ");
