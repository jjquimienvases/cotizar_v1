...
$email = $_POST['email'];
$status = "pendiente"; // este estado es mientras subo la parte de caja. despues debe cambiar el default a pendiente.
//productos
...
//   for ($i=0; $i < count ($codigo)  ; $i++) {
//      $sql1="UPDATE producto SET stock ='$nuevostock[$i]' WHERE id = '$codigo[$i]'";
