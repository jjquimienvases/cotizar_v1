...
function formatear($num){
  ...
  $sentencia_select=$con->prepare('SELECT * FROM `factura_orden` WHERE metodopago = "mostrador_ibague_1" AND estado != "anulado"');
	...
	if(isset($_POST['btn_buscar'])){
		...
		$select_buscar=$con->prepare('
			SELECT * FROM factura_orden WHERE order_id LIKE :campo OR order_receiver_name LIKE :campo OR order_receiver_address LIKE :campo OR order_date LIKE :campo AND metodopago = "mostrador_ibague_1" AND estado != "anulado";'
		);
...
<head><meta charset="euc-jp">
	...
	<title>Reporte de ventas ibague 1</title>
...
<body>
	<div class="contenedor">
		...
		<h2>Cotizaciones mostrador ibague 1</h2>
