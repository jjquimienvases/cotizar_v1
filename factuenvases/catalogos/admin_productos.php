...
<body>
	...
	<div class="contenedor">
		<a href="banner.php"> <button type="button" class="btn btn-outline-warning">Ver todos los stocks</button></a>
    ...
    <a href="banner.php">  <span class="glyphicon glyphicon-edit"> <button type="button" class="btn btn-primary">BANNER</button> </span></a>
        ...
        <td colspan="2">Acciones</td>
			...
			<?php foreach($resultado as $fila):?>
				<form class="" action="eliminar_item.php" method="post">
				<tr >

					<td> <input name="codigo" value="<?php echo $fila['id']; ?>"> </td>
           ...
           ?>
             ...
             $categoria = $fila['id_categoria'];
						 					 ...
						 					 ?>
					<td><img src="<?php echo $fila['imagen'];?>" alt="<?php echo $fila['contratipo'];?>" class="img-fluid" width="100" height="100" style="margin-left: 70px" ></td>
           <?php
					 if ($categoria == 4 ) {
						 $precio= $fila['gramo'];
 						$gramo= $precio/1000;
        ...
        <td> <button name="eliminar_items" type="submit" value="<?php echo $fila['id']; ?>">Eliminar</button> </td>
