...
function formatear($num){
  ...
  $sentencia_select=$con->prepare('SELECT * FROM `factura_modificada` WHERE punto_pago = ""');
	...
	if(isset($_POST['btn_buscar'])){
		...
		$select_buscar=$con->prepare('
			SELECT * FROM factura_modificada WHERE order_id LIKE :campo OR order_date LIKE :campo AND punto_pago != "mostradorjj" ;'
		);
...
<head><meta charset="euc-jp">
	...
	<title>Reporte de ventas Call Center</title>
...
<body>
	<div class="contenedor">
		...
		<h2>Cotizaciones Efecticas Call Center</h2>
