...
function formatear($num){
  ...
  $sentencia_select=$con->prepare('SELECT * FROM `factura_orden` WHERE metodopago = "mostradord1" AND estado != "anulado"');
	...
	if(isset($_POST['btn_buscar'])){
		...
		$select_buscar=$con->prepare('
			SELECT * FROM factura_orden WHERE order_id LIKE :campo OR order_receiver_name LIKE :campo OR order_receiver_address LIKE :campo OR order_date LIKE :campo AND metodopago = "mostradord1" AND estado != "anulado";'
		);
...
<head><meta charset="euc-jp">
	...
	<title>Reporte de ventas D1</title>
