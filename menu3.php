...
<li class="dropdown">
	...
	<ul class="dropdown-menu">
		<li><a href="listamostrador.php">Tus Cotizaciones</a></li>
		<li><a href="create_invoice2.php">Crear Cotizacion</a></li>
	</ul>
</li>
<?php
if($_SESSION['userid']) { ?>
	<li class="dropdown">
		...
		<span class="caret"></span></button>
		<ul class="dropdown-menu">
			<li><a href="listamostrador.php">Mis cotizaciones</a></li>	
