...
// <center><img src="JJ CIRCULO LOGO (fondo blanco).png" id="logo" width="300" height="200"> </center>
 ...
 $output .= '<link href="css/style_etiquetas_t.css" rel="stylesheet" type="text/css"   media="screen" />';
 ...
 foreach($execute as $data_c){
     ...
     <img src="../logotipo.jpg" id="logo" width="50" height="50">
     </div>';
