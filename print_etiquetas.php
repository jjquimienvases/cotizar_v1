...
//  $sql_ = "SELECT * FROM factura_orden fo INNER JOIN factura_orden_producto fp ON fo.order_id = fp.order_id  WHERE fo.order_id = $cotizacion AND fp.item_categoria = 13";
...
// <center><img src="JJ CIRCULO LOGO (fondo blanco).png" id="logo" width="300" height="200"> </center>
 ...
 $output .= '<link href="css/style_etiquetas.css" rel="stylesheet" type="text/css"   media="screen" />';
