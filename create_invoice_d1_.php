...
<script src="js/invoice_d1_.js"></script>
            ...
            <div class="load-animate animated fadeInUp">
                <div class="row">
                    <div class="col-md-6 col-xl-6 col-sm-6 col-lg-6">
                        <h2 class="title">Crear una nueva cotizacion D1</h2>
                    ...
                    <div class="col-md-6 col-xl-6 col-sm-6 col-lg-6 ">
                        ...
                        <hr>
                        <div class="form-group">
                            <input type="hidden" value="mostradord1" name="metodopago">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
                    ...
                    <div class="guardado_group">
                        ...
                        <input type="hidden" value="" id="user_rol" name="user_rol" class="form-control">
