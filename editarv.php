...
<div class="container content-invoice">
    	<form action="" id="invoice-form" method="post" class="invoice-form" role="form" novalidate>
	    	<div class="load-animate animated fadeInUp">
		    	<div class="row">
		    		<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
		    			<h1 class="title">Sistema de cotizacion JJ QUIMIENVASES</h1>
			...
			<input value="<?php echo $invoiceValues['ciudad']; ?>" type="text" class="form-control" name="ciudad" id="ciudad" placeholder="Ciudad" autocomplete="off">
						...
						<div class="form-group">
							<textarea class="form-control" rows="3" name="address" id="address" placeholder="Cotizante"><?php echo $invoiceValues['order_receiver_address']; ?></textarea>
						</div>
						<div class="form-group">
							<input class="form-control" rows="3" name="leiner" id="leiner" placeholder="Ingresar numero de factura">
						</div>
 <div class="form-group">
...
<label for="">Perfume Lujo</label>
   <td><input class="itemlujo" type="checkbox" id="envase" name="envase"> </td> </div>
...
<table class="table_contenedor" id="invoiceItem">
<tr>
