...
<head>
	...
	<title>Agregar a pendientes</title>
...
<body>
  ...
  <?php include 'barra_comercial.php' ?>
<center>
 <h3>Agregar a pendientes</h3>
</center>
	<div class="container">
		<div class="form__top">
            ...
            <div class="inputfield">
              ...
              <div class="custom_select">
                <select name="estadoactual">
                  <option value="pendiente" class="custom_option" selected >pendientes</option>
                </select>
              </div>
            </div>
            <hr>
            <div class="btn__form">
            	<input class="btn__submit" type="submit" id="guardando" doiclicksito value="REGISTRAR">
 ...
 <button href="Panel_Comerciales.php" class="btn btn-success"> Volver al panel </button>		
	</div>
				...
				$.ajax({
					...
					success:function(r){
						...
						if(r!=0 && !isNaN(r)){//SI ES DISTINTO A 0 Y ES UN NUMERO
                            ...
                            window.location="adjuntar_pendientes.php";
