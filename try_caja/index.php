...
$sel = $cnx->query("SELECT * FROM factura_orden WHERE estado = '$status' AND metodopago = '$bodega' ORDER BY order_date DESC LIMIT 10");

$seleccion = $cnx->query("SELECT count(*) AS total FROM factura_orden WHERE estado = '$status' AND metodopago = '$bodega'");
      ...
      <center>
        ...
        <div class="barra__buscador">
          <form action="" class="formulario" method="post">
            <input type="text" name="buscar" id="buscador" placeholder="buscar ID  o Fecha" value="<?php if (isset($buscar_text)) echo $buscar_text; ?>" class="form-group">
