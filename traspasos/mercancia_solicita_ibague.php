...
$status = "solicitud";
$bodega_ibague = "productos_ibague";
$sel = $con->query("SELECT * FROM traspasos WHERE estado = '$status' AND bodega_entrada = '$bodega_ibague' ");
...
<html>
    <head>
        ...
        <title>Solicita Ibague</title>
        <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css" integrity="sha384-JcKb8q3iqJ61gNV9KGb8thSsNjpSL0n8PARn9HuZOnIxN0hoP+VmmDGMN5t9UJ0Z" crossorigin="anonymous">
    </head>
    <body>
      <h2>Mercancia solicitada por ibague</h2>
