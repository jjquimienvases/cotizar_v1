...
$result = $cnx->query("SELECT count(*) as total FROM notificaciones WHERE estado = 'pendiente' ");
$data = mysqli_fetch_assoc($result);

$cuenta = $data['total'];

$alistamiento = "pendiente";
$resultados = $cnx->query("SELECT count(*) as totales FROM files WHERE estado = 'pendiente' ");
				...
				<div class="row">
					...
					<div class="col-lg-4 col-md-12 mb-4">
						<div class="card-section card-section-third border rounded">
							...
							<div class="card-body text-center mb-2">
								<strong>
									<p>Tienes ( <?php echo $cuenta;   ?> ) Facturas pendientes</p>
								</strong>
					...
					<div class="col-lg-4 col-md-12 mb-4">
						<div class="card-section card-section-third border rounded">
							...
							<div class="card-body text-center mb-2">
								<strong>
									<p>Tienes ( <?php echo $cuentas;   ?> ) Cotizaciones pendientes</p>
								</strong>
